...
\x1b[1;96m┏─══─━══─══━─══─| ✠ |─══━─══─══━─══─┓
\x1b[38;5;46m┃AUTHOR    ; AJOY Gaming            ┃
\x1b[1;93m┃WHATSAPP  ; +8801883190328         ┃
\x1b[1;95m┃FACEBOOK  ; CTG King          ┃
\x1b[1;91m┃GITHUB    ; AJOY Gaming┃
\x1b[1;96m┗─══─━════─━─══─| ✠ |─══━─══─══━─══─┛
...
def fuck():
    ...
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100075905358657')
    print(logo)
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for love in user:
            ...
            yaari.submit(AJOYsexy2,uid,pwx,tl)
    print('•────────────────•°•❀•°•────────────────•')
